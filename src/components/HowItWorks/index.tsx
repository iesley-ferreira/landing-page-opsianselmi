      ...
      <div className="container px-4 mx-auto">
        <div className="md:max-w-4xl mb-16 md:mb-20">
          ...
          <p className="text-lg md:text-xl text-coolGray-500 font-medium">
            A terapia online oferece uma maneira conveniente e eficaz de cuidar da sua
            saúde mental, com a flexibilidade de participar de sessões no conforto de sua
          ...
          <div className="w-full md:w-1/2 px-4 mb-8 md:mb-0">
            <div className="flex flex-wrap p-8 text-center md:text-left hover:bg-white rounded-md hover:shadow-xl transition duration-200">
              ...
              <div className="w-full md:flex-1 md:pt-3">
                ...
                <p className="text-coolGray-500 font-medium">
                  A terapia online é realizada através de videoconferências em plataformas
                  seguras, proporcionando o mesmo nível de confidencialidade e apoio
                  emocional que as sessões presenciais.
                </p>
              </div>
            </div>
            <div className="flex flex-wrap p-8 text-center md:text-left hover:bg-white rounded-md hover:shadow-xl transition duration-200">
              ...
              <div className="w-full md:flex-1 md:pt-3">
                ...
                <p className="text-coolGray-500 font-medium">
                  A terapia online permite que você participe das sessões no conforto do
                  seu lar, ou de qualquer outro lugar que preferir, sem a necessidade de
                  deslocamento.
                </p>
              </div>
            </div>
            <div className="flex flex-wrap p-8 text-center md:text-left hover:bg-white rounded-md hover:shadow-xl transition duration-200">
              ...
              <div className="w-full md:flex-1 md:pt-3">
                ...
                <p className="text-coolGray-500 font-medium">
                  Com a terapia online, você tem acesso fácil e rápido a profissionais de
                  saúde mental, independentemente de onde você esteja.
                </p>
              </div>
            </div>
          </div>
          <div className="w-full md:w-1/2 px-4">
            <div className="relative mx-auto md:mr-0 max-w-max">
              ...
              <img
                ...
                src="/assets/elements/dots3-red.svg"
                alt=""
              />
              <img src="/assets/howItWorks/stock2.png" alt="Therapy online" />
            </div>
          </div>
        </div>
      </div>
